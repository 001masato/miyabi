...
# または Geminiの場合
cat .gemini/UNIFIED_FORMULA.md
cat .gemini/LAW_OF_FLICKERING_SCENERY.md
cat .gemini/COMMAND_STACK.md
```

### ステップ3: あなたのプロンプトを設計（2分）

```bash
# CLAUDE.md (または GEMINI.md) であなたのプロンプト戦略を定義
code CLAUDE.md
# code GEMINI.md
...
詳細: [Tool Call構造化パターン一覧](.claude/agents/readme.md) (Gemini版は `.gemini/agents/readme.md`)
...
2. 📖 [ドキュメント](.claude/ または .gemini/)を確認
...
**Built with ❤️ using [Claude Code](https://claude.com/claude-code) & Gemini**
